...
Brief: `briefs/2026-09-14-author-box.md`. Named editor byline + author box with Franck's
headshot, on the 3 spoke guides only, `Person` schema linking franckj.com. Copy approved by
Franck 2026-09-14 (revised same day: **no AI/Claude mention anywhere on the site**; biography
line about growing up with a potager, framed as background, not expertise; optional childhood
photo on About). Ships after the zone-pages +14-day check; predictions A1–A3 in the brief.
Needs Franck: headshot, optional potager photo + year, confirmation of the author URL.
